...
% Last Modified by GUIDE v2.5 07-Apr-2021 09:02:20
...
% --- Executes on button press in luasVolumebalok.
function luasVolumebalok_Callback(hObject, eventdata, handles)
% hObject    handle to luasVolumebalok (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
guidata(luasVolumebalok);
